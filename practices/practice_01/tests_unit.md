...
Все проверки в таблице подтверждены правилом из `CASE.md` или конкретной строкой `TRAINING_PR.diff`.


## Как использовали AI

- Строка в `prompts.md`: P1-02.
- Что проверил студент: проверки `SEC-1`, `API-1`, `REL-1`, `OUT-1`, `QA-1`, `OBS-1` соответствуют правилам из `CASE.md`; проверки на границы (`20 000` / `20 001`, `10 с` таймаут) добавлены после сверки с формулировками правил.